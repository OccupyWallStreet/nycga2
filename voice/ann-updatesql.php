...
//include("/var/www/nycga.net/web/wp-includes/post.php");
  ...
  $titlepost = "Voice Announcement from $callername at $datetime";
  $wavlink = "<embed src='$currentvm' autostart=false loop=false>";
  $contentpost = "$wavlink <br><a href= $currentvm target='_blank'>Download Voice File</a><br><br><i>This post was generated by the NYCGA Voice Services at 1-855-203-7763.  Add your mobile phone number to your account profile and call in for personalized services.</i>";
