...
<?php else : ?>
<div id="logout-link">
<?php bp_loggedin_user_avatar( 'width=30&height=30' ) ?> &nbsp; <?php bp_loggedin_user_link() ?> / <a href="<?php echo wp_logout_url( bp_get_root_domain() ) ?>"><?php _e( 'Log Out', TEMPLATE_DOMAIN ) ?></a>
