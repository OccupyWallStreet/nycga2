...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'business-blog' ),
		'accepted'          => __( 'Accepted', 'business-blog' ),
		'rejected'          => __( 'Rejected', 'business-blog' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'business-blog' ),
		'show_all'          => __( 'Show all', 'business-blog' ),
		'comments'          => __( 'comments', 'business-blog' ),
		'close'             => __( 'Close', 'business-blog' ),
		'view'              => __( 'View', 'business-blog' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'business-blog' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
