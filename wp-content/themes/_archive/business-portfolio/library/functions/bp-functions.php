...
require_once( get_template_directory() . '/_inc/ajax.php' );
...
$params = array(
	'my_favs'           => __( 'My Favorites', 'business-portfolio' ),
	'accepted'          => __( 'Accepted', 'business-portfolio' ),
	'rejected'          => __( 'Rejected', 'business-portfolio' ),
	'show_all_comments' => __( 'Show all comments for this thread', 'business-portfolio' ),
	'show_all'          => __( 'Show all', 'business-portfolio' ),
	'comments'          => __( 'comments', 'business-portfolio' ),
	'close'             => __( 'Close', 'business-portfolio' ),
	'mention_explain'   => sprintf( __( "%s is a unique identifier for %s that you can type into any message on this site. %s will be sent a notification and a link to your message any time you use it.", 'business-portfolio' ), '@' . bp_get_displayed_user_username(), bp_get_user_firstname( bp_get_displayed_user_fullname() ), bp_get_user_firstname( bp_get_displayed_user_fullname() ) )
);
	...
	<li id="comment-<?php comment_ID(); ?>">
		...
		<div class="comment-content">
			...
			<div class="comment-meta">
				<a href="<?php echo get_comment_author_url() ?>" rel="nofollow"><?php echo get_comment_author(); ?></a> <?php _e( 'said:', 'business-portfolio' ) ?>
				<em><?php _e( 'On', 'business-portfolio' ) ?> <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date() ?></a></em>
			</div>
...
function bp_dtheme_wp_pages_filter( $page_html ) {
	...
	$page_html .= '<option class="level-0" value="activity"' . $selected . '>' . __( 'Activity Stream', 'business-portfolio' ) . '</option></select>';
	return $page_html;
}
...
function bp_dtheme_show_notice() { ?>
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated!', 'business-portfolio' )) ?></p>
	</div>
