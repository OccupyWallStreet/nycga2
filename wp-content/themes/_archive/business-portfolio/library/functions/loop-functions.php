...
function bp_wpmu_blogpage_loop(){
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="author-box">
				...
				<p><?php _e( 'by ', 'business-portfolio' ) ?><?php the_author_link();  ?></p>
			</div>
			<div class="post-content">
				<h2 class="posttitle"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to', 'business-portfolio' ) ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
				<p class="date"><?php the_time('M j Y') ?> <em><?php _e( 'in', 'business-portfolio' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'business-portfolio' ) ?><?php the_author_link();  ?></em></p>
				<div class="entry">
				...
				<p class="postmetadata"><span class="tags"><?php the_tags( __( 'Tags: ', 'business-portfolio' ), ', ', '<br />'); ?></span> <span class="comments"><?php comments_popup_link( __( 'No Comments &#187;', 'business-portfolio' ), __( '1 Comment &#187;', 'business-portfolio' ), __( '% Comments &#187;', 'business-portfolio' ) ); ?></span></p>
			</div>
		</div>
			<?php endwhile;
}
...
function wpmu_blogpage_loop(){
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="post-content-wp">
				<h2 class="posttitle"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to', 'business-portfolio' ) ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
					<p class="date"><span class="byline"><?php the_time('M j Y') ?> <?php _e( 'in', 'business-portfolio' ) ?> <?php the_category(', ') ?> <em><?php _e( 'by ', 'business-portfolio' ) ?><?php the_author_link();  ?></em></span></p>
						<div class="entry">
									<a href="<?php the_permalink() ?>">
										<?php if(function_exists('the_post_thumbnail')) { ?><?php if(get_the_post_thumbnail() != "") { ?><div class="alignleft">
										<?php the_post_thumbnail(); ?></div><?php } } ?>
		...
		while (have_posts()) : the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
				...
				<div class="post-content">
					...
					<p class="date"><?php the_time('M j Y') ?> <em><?php _e( 'in', 'business-portfolio' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'business-portfolio' ) ?><?php the_author_link();  ?></em></p>
					<div class="entry">
						<?php the_content( __( 'Read the rest of this entry &rarr;', 'business-portfolio' ) ); ?>
					</div>
					<p class="postmetadata"><span class="tags"><?php the_tags( __( 'Tags: ', 'business-portfolio' ), ', ', '<br />'); ?></span> <span class="comments"><?php comments_popup_link( __( 'No Comments &#187;', 'business-portfolio' ), __( '1 Comment &#187;', 'business-portfolio' ), __( '% Comments &#187;', 'business-portfolio' ) ); ?></span></p>
				</div>
			</div>
...
function bp_wpmu_page_loop(){
		...
		while (have_posts()) : the_post(); ?>
			...
			<div class="post" id="post-<?php the_ID(); ?>">
				<div class="entry">
					<?php the_content( __( '<p class="serif">Read the rest of this page &rarr;</p>', 'business-portfolio' ) ); ?>
					<?php wp_link_pages( array( 'before' => __( '<p><strong>Pages:</strong> ', 'business-portfolio' ), 'after' => '</p>', 'next_or_number' => 'number')); ?>
					<?php edit_post_link( __( 'Edit this entry.', 'business-portfolio' ), '<p>', '</p>'); ?>
				</div>
			</div>
			...
			$_post = &get_post($post->ID); $classname = ($_post->iconsize[0] <= 128 ? 'small' : '') . 'attachment'; // This lets us style narrow icons specially ?>
				...
				<div class="post" id="post-<?php the_ID(); ?>">
					...
					<div class="entry">
						...
						<?php the_content( __('<p class="serif">Read the rest of this entry &rarr;</p>', 'business-portfolio' ) ); ?>
