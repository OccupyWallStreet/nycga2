            ...
            <table>
                ...
                <?php while ( have_posts() ) : the_post(); ?>
				            ...
				            <tr class="event">
					            ...
					            <td class="event_title"><h2 class="wpmudevevents-header"><?php echo Eab_Template::get_event_link($post); ?></h2><div class="event-thumbnail"><?php the_post_thumbnail(); ?></div></td>
