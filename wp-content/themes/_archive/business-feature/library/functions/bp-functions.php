...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'business-feature' ),
		'accepted'          => __( 'Accepted', 'business-feature' ),
		'rejected'          => __( 'Rejected', 'business-feature' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'business-feature' ),
		'show_all'          => __( 'Show all', 'business-feature' ),
		'comments'          => __( 'comments', 'business-feature' ),
		'close'             => __( 'Close', 'business-feature' ),
		'view'              => __( 'View', 'business-feature' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'business-feature' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
