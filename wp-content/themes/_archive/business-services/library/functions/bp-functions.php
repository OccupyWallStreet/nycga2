...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'business-services' ),
		'accepted'          => __( 'Accepted', 'business-services' ),
		'rejected'          => __( 'Rejected', 'business-services' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'business-services' ),
		'show_all'          => __( 'Show all', 'business-services' ),
		'comments'          => __( 'comments', 'business-services' ),
		'close'             => __( 'Close', 'business-services' ),
		'view'              => __( 'View', 'business-services' )
	);
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'business-services' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
