	...
	<div class="hfeed">
		...
		<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
			...
			<div class="loop-meta">
				...
				<h1 class="loop-title dir-title"><?php _e( 'Create a Group', 'buddypress' ); ?> &nbsp;<a class="button" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>"><?php _e( 'Groups Directory', 'buddypress' ); ?></a></h1>
			
			</div><!-- .loop-meta -->

			<?php do_action( 'bp_before_create_group' ); ?>

			<div class="item-list-tabs bp-tabs no-ajax" id="group-create-tabs" role="navigation">
				<ul>
			...
			<div class="item-body" id="group-create-body">
				...
				<div class="entry-content">
					...
					<p class="radio">
						<label>
							<input type="radio" name="group-status" value="public"<?php if ( 'public' == bp_get_new_group_status() || !bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> /> <strong><?php _e( 'This is a public group', 'buddypress' ); ?></strong>
						</label>
					</p>
					...
					<p>
						<label>
							<input type="radio" name="group-status" value="private"<?php if ( 'private' == bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> /> <strong><?php _e( 'This is a private group', 'buddypress' ); ?></strong>
						</label>
					</p>
					...
					<p>
						<label><input type="radio" name="group-status" value="hidden"<?php if ( 'hidden' == bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> /> <strong><?php _e('This is a hidden group', 'buddypress'); ?></strong>
						</label>
					</p>
					...
					<h3><?php _e( 'Group Invitations', 'buddypress' ); ?></h3>
