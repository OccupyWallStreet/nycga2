<?php
/**
 * TimThumb script created by
 * Ben Gillbanks, originally created by Tim McDaniels and Darren Hoyt
...
// modifying directory cache so uploads folder doesn't have to be created - David Bisset

if ($multisite == "true" && $blogdirid > 0) { 
	// If we are dealing with multisite, let's create a cache folder in blogs.dir/BLOG_ID
	define ('DIRECTORY_CACHE', '../../../../blogs.dir/'.$blogdirid.'/cache');		// cache directory
} else {
	// If we aren't dealing with multisite, then 
