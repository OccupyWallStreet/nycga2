...
//REMOVE BuddyPress Default Styles
...
{ 
  ...
  wp_register_style( 'type', get_template_directory_uri() . '/css/type.css');
  wp_register_style( 'grid', get_template_directory_uri() . '/css/grid_1000_24.css');
  wp_register_style( 'events', get_template_directory_uri() . '/css/events.css');
  wp_register_style( 'nycga-core', get_template_directory_uri() . '/css/nycga_core.css', array(), '20120729', 'all' );
...
// FOR DEBUGGING - for logged in users, this will return the name of the template being used
	...
	function display_template_name() {
		...
		//Debugging code will display only to logged in users
			echo 'Called from functions.php: ';
			echo ' | '. get_template_name() ;
		}
	}
	//add_action('bp_after_footer', 'display_template_name');


// FOR DEBUGGING - for logged in users, this will return the full URL of the current page
	...
	//add_action('bp_footer', 'display_current_page_url');
