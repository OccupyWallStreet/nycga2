...
$admincpMainTabs = array('general','navigation','layout','seo','integration','doc');
	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Theme Stylesheet",
				   ...
				   "type" => "select",
				   "std" => "default.css",
				   "options" => array("default.css","black.css","green.css","orange.css","pink.css","red.css"),
			...
			array( "name" => "Footer Credit",
				   ...
				   "type" => "textarea",
				   "std" => "Powered by <a href=\"http://wordpress.org\">WordPress</a> &middot; Designed by <a href=\"http://www.theme-junkie.com\">Theme Junkie</a>",
				   "desc" => "desc",),
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
            ...
            array( "name" => "Slogan",
                   ...
                   "type" => "textarea",
                   "std" => "<h3>Your WordPress Expert</h3>Welcome to our workspace. We are a small Huston based <a href='#'>design studio</a> with heavy focus on <a href='#'>WordPress theming</a>, HTML, CSS and Javascript.",
				   "desc" => "desc."),				   

            array( "name" => "Slogan Button Text",
                   "id" => $shortname."_slogan_button_text",
                   "type" => "text",
                   "std" => "Get a Quote",
				   "desc" => "desc."),

            array( "name" => "Slogan Button Link",
                   "id" => $shortname."_slogan_button_link",
                   "type" => "text",
                   "std" => "http://www.theme-junkie.com",
				   "desc" => "desc."),				   

            array( "name" => "Enable Recent Portfolio Posts on homepage",
                   "id" => $shortname."_home_portfolio_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),

            array( "name" => "Number of Portfolio Posts to show",
                   "id" => $shortname."_home_portfolio_posts_num",
                   "type" => "text",
                   "std" => "3",
				   "desc" => "desc."),				   				   

            array( "name" => "Title of Recent Portfolio Posts",
                   "id" => $shortname."_home_portfolio_title",
                   "type" => "text",
                   "std" => "Recent Work",
				   "desc" => "desc."),				   

            array( "name" => "Description of Recent Portfolio Posts",
                   "id" => $shortname."_home_portfolio_desc",
                   "type" => "textarea",
                   "std" => "Ut tincidunt vehicula ligula, sit amet feugiat justo mattis id. Integer sit amet justo nisi, eu interdum augue. Quisque purus dui, facilisis nec adipiscing. <br/> <a href='#'>See more work</a>",
				   "desc" => "desc."),
				   
            array( "name" => "Enable Recent Blog Posts on homepage",
                   "id" => $shortname."_home_blog_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),

            array( "name" => "Number of Blog Posts to show",
                   "id" => $shortname."_home_blog_posts_num",
                   "type" => "text",
                   "std" => "3",
				   "desc" => "desc."),					   

            array( "name" => "Title of Recent Blog Posts",
                   "id" => $shortname."_home_blog_title",
                   "type" => "text",
                   "std" => "From The Blog",
				   "desc" => "desc."),

            array( "name" => "Description of Recent Blog Posts",
                   "id" => $shortname."_home_blog_desc",
                   "type" => "textarea",
                   "std" => "Ut tincidunt vehicula ligula, sit amet feugiat justo mattis id. Integer sit amet justo nisi, eu interdum augue. Quisque purus dui, facilisis nec adipiscing. <br/> <a href='#'>Read the blog</a>",
				   "desc" => "desc."),

            array( "name" => "Footer Callout Left",
				   "id" => $shortname."_callout_left",
				   "type" => "textarea",
				   "std" => "You could fill this section with client logos or anything else...",
				   "desc" => "desc",),

			array( "type" => "clearfix",),

            array( "name" => "Footer Callout Right",
				   "id" => $shortname."_callout_right",
				   "type" => "textarea",
				   "std" => "<img src='".get_template_directory_uri() . "/images/logo-twitter.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-facebook.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-rackspace.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-digg.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-yahoo.png' alt=''/><img src='".get_template_directory_uri() . "/images/logo-shopify.png' alt=''/>",
				   "desc" => "desc",),
		...
		array( "name" => "layout-2",
            ...
            array( "name" => "Number of images to show on Image Gallery page",
            ...
            array( "name" => "Show comments on portfolio",
            "id" => $shortname."_show_portfolio_comments",
            "type" => "checkbox2",
            "std" => "false",
			"desc" => "You can disable this option if you want to remove the comments and comment form from single portfolio pages. "),
