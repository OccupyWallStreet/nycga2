...
<div id="sidebar">
	...
	<?php if ( is_user_logged_in() ) : ?>
		...
		<div id="sidebar-me">
			<a href="<?php echo bp_loggedin_user_domain() ?>" title="Edit profile">
	...
	<?php else : ?>
		...
		<form name="login-form" id="sidebar-login-form" class="standard-form" action="<?php echo site_url( 'wp-login.php', 'login_post' ) ?>" method="post">
			...
			<input type="hidden" name="testcookie" value="1" /><br /><br />

			<?php if ( bp_get_signup_allowed() ) : ?>
				<?php printf( __( 'Create your <strong><a href="%s" title="Create your new account!">new account</a></strong>!', 'buddypress' ), site_url( '/wp-signup.php' ) ) ?>
			<?php endif; ?>

			<?php printf( __( '<strong><a href="%s" title="Forgotten your password?">Forgotten</a></strong> your password?', 'buddypress' ), site_url( "/wp-login.php?action=lostpassword" ) ) ?>
