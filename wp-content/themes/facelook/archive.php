<?php get_header(); ?>
	...
	<div id="content">
		...
		<div class="page" id="blog-archives">
			...
			<h3 class="pagetitle"><?php printf( __( 'Posts with the name or tag of %1$s;', 'buddypress' ), wp_title( false, false ) ); ?></h3>
				...
				<?php while (have_posts()) : the_post(); ?>
					...
					<div class="post" id="post-<?php the_ID(); ?>">
						...
						<div class="post-content">
							...
							<p class="postmetadata"><span class="tags"><?php the_tags( __( 'Tags: ', 'buddypress' ), ', ', '<br />'); ?></span></span></p>
						</div>
