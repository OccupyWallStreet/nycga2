...
<div class="em-events-search">
	...
	<form action="<?php echo EM_URI; ?>" method="post" class="em-events-search-form">
		...
		<fieldset name="title-search">
			<legend class="title-name">Title</legend>
		...
		<!-- START Date Search -->
		<fieldset name="date-range-search">
			<legend class="date-ranges">Date Range</legend>
		...
		<!-- START Category Search -->
			<fieldset name="category-search">
			<legend class="category-names">Category</legend>
				<?php 
		...
		<?php if ( ! bp_is_group() && bp_has_groups('type=alphabetical&per_page=all') ) : //Jessica ?> 
		<!-- START Group Search -->
		<fieldset name="group-search">
			<legend class="group-search">Group</legend>
			<select name="group" class="em-events-search-category">
				<option value=''><?php _e('All Groups','dbem'); ?></option>
				<option value='my' <?php echo (!empty($_REQUEST['group']) && $_REQUEST['group'] == 'my') ? 'selected="selected"':''; ?>><?php _e('My Groups','dbem'); ?></option>
		...
		<fieldset name="country-search">
			<legend class="countries">Country</legend>
