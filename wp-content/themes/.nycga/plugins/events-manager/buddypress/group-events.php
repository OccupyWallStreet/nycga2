...
/* WARNING! This file may change in the near future as we intend to add features to BuddyPress - 2012-02-14 */
	...
	?>
	<?php //ERICLEWIS ADD LINK TO ADD NEW EVENT 
	if( groups_is_user_admin(get_current_user_id(), $bp->groups->current_group->id) || groups_is_user_mod(get_current_user_id(), $bp->groups->current_group->id) ) : ?>
		<a href="/events/event-edit/?action=edit&group_id=<?php echo $bp->groups->current_group->id ?>" class="button add-new-h2"><?php _e('Add New Event','dbem'); ?></a>
	<?php endif; ?>
