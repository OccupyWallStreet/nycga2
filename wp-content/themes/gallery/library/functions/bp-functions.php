...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'gallery' ),
		'accepted'          => __( 'Accepted', 'gallery' ),
		'rejected'          => __( 'Rejected', 'gallery' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'gallery' ),
		'show_all'          => __( 'Show all', 'gallery' ),
		'comments'          => __( 'comments', 'gallery' ),
		'close'             => __( 'Close', 'gallery' ),
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'gallery' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
