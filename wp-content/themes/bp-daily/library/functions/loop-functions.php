		...
		$page = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts("cat=&showposts=5&paged=$page"); while ( have_posts() ) : the_post();?>
		 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="author-box">
				...
				<p><?php _e( 'by ', 'bp-daily' ) ?><?php the_author_link();  ?></p>
			</div>
			<div class="post-content">
				...
				<p class="date"><?php the_time('M j Y') ?> <em><?php _e( 'in', 'bp-daily' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'bp-daily' ) ?><?php the_author_link();  ?></em></p>
				<div class="entry">
		...
		$page = (get_query_var('paged')) ? get_query_var('paged') : 1; query_posts("cat=&showposts=5&paged=$page"); while ( have_posts() ) : the_post();?>
		 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post-content-wp">
				<h2 class="posttitle"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to', 'bp-daily' ) ?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
					<p class="date"><span class="byline"><?php the_time('M j Y') ?> <?php _e( 'in', 'bp-daily' ) ?> <?php the_category(', ') ?> <em><?php _e( 'by ', 'bp-daily' ) ?><?php the_author_link();  ?></em></span></p>
						<div class="entry">
									<a href="<?php the_permalink() ?>">
										<?php if(function_exists('the_post_thumbnail')) { ?><?php if(get_the_post_thumbnail() != "") { ?><div class="alignleft">
										<?php the_post_thumbnail(); ?></div><?php } } ?>
			...
			$_post = &get_post($post->ID); $classname = ($_post->iconsize[0] <= 128 ? 'small' : '') . 'attachment'; // This lets us style narrow icons specially ?>
				 ...
				 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry">
						...
						<?php the_content( __('<p class="serif">Read the rest of this entry &rarr;</p>', 'bp-daily' ) ); ?>
