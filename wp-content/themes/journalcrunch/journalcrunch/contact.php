...
<!-- begin colLeft -->
	<div id="colLeft">
			...
			<input type="hidden" id="receiver" name="receiver" value="<?php echo get_option('journal_contact_email')?>"/>
			<!--<input type="hidden" id="from_email" name="from_email" value="<?php echo get_option('journal_from_email')?>"/>-->
			</form>
