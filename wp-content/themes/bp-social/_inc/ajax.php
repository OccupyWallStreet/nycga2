 ...
 */
function bp_dtheme_ajax_querystring_social( $query_string, $object ) {
	global $bp;
	...
	return apply_filters( 'bp_dtheme_ajax_querystring_social', $query_string, $object, $object_filter, $object_scope, $object_page, $object_search_terms, $object_extras );
}
add_filter( 'bp_ajax_querystring', 'bp_dtheme_ajax_querystring_social', 10, 2 );

/* This function will simply load the template loop for the current object. On an AJAX request */
function bp_dtheme_object_template_loader_social() {
...
add_action( 'wp_ajax_members_filter', 'bp_dtheme_object_template_loader_social' );
add_action( 'wp_ajax_groups_filter',  'bp_dtheme_object_template_loader_social' );
add_action( 'wp_ajax_blogs_filter',   'bp_dtheme_object_template_loader_social' );
add_action( 'wp_ajax_forums_filter',  'bp_dtheme_object_template_loader_social' );

// This function will load the activity loop template when activity is requested via AJAX
function bp_dtheme_activity_template_loader_social() {
	global $bp;
...
add_action( 'wp_ajax_activity_widget_filter', 'bp_dtheme_activity_template_loader_social' );
add_action( 'wp_ajax_activity_get_older_updates', 'bp_dtheme_activity_template_loader_social' );

/* AJAX update posting */
function bp_dtheme_post_update_social() {
	global $bp;
...
add_action( 'wp_ajax_post_update', 'bp_dtheme_post_update_social' );

/* AJAX activity comment posting */
function bp_dtheme_new_activity_comment_social() {
	global $bp;
...
add_action( 'wp_ajax_new_activity_comment', 'bp_dtheme_new_activity_comment_social' );

/* AJAX delete an activity */
function bp_dtheme_delete_activity_social() {
	global $bp;
...
add_action( 'wp_ajax_delete_activity', 'bp_dtheme_delete_activity_social' );

/* AJAX delete an activity comment */
function bp_dtheme_delete_activity_comment_social() {
	global $bp;
...
add_action( 'wp_ajax_delete_activity_comment', 'bp_dtheme_delete_activity_comment_social' );

/* AJAX mark an activity as a favorite */
function bp_dtheme_mark_activity_favorite_social() {
	global $bp;

	bp_activity_add_user_favorite( $_POST['id'] );
	_e( 'Remove Favorite', 'buddypress' );
}
add_action( 'wp_ajax_activity_mark_fav', 'bp_dtheme_mark_activity_favorite_social' );

/* AJAX mark an activity as not a favorite */
function bp_dtheme_unmark_activity_favorite_social() {
	global $bp;

	bp_activity_remove_user_favorite( $_POST['id'] );
	_e( 'Favorite', 'buddypress' );
}
add_action( 'wp_ajax_activity_mark_unfav', 'bp_dtheme_unmark_activity_favorite_social' );
 ...
 * @since 1.5
 */
function bp_dtheme_get_single_activity_content_social() {
	...
	do_action_ref_array( 'bp_dtheme_get_single_activity_content_social', array( &$activity ) );
...
add_action( 'wp_ajax_get_single_activity_content', 'bp_dtheme_get_single_activity_content_social' );

/* AJAX invite a friend to a group functionality */
function bp_dtheme_ajax_invite_user_social() {
	global $bp;
...
add_action( 'wp_ajax_groups_invite_user', 'bp_dtheme_ajax_invite_user_social' );

/* AJAX add/remove a user as a friend when clicking the button */
function bp_dtheme_ajax_addremove_friend_social() {
	global $bp;
...
add_action( 'wp_ajax_addremove_friend', 'bp_dtheme_ajax_addremove_friend_social' );

/* AJAX accept a user as a friend when clicking the "accept" button */
function bp_dtheme_ajax_accept_friendship_social() {
...
add_action( 'wp_ajax_accept_friendship', 'bp_dtheme_ajax_accept_friendship_social' );

/* AJAX reject a user as a friend when clicking the "reject" button */
function bp_dtheme_ajax_reject_friendship_social() {
...
add_action( 'wp_ajax_reject_friendship', 'bp_dtheme_ajax_reject_friendship_social' );

/* AJAX join or leave a group when clicking the "join/leave" button */
function bp_dtheme_ajax_joinleave_group_social() {
	global $bp;
...
add_action( 'wp_ajax_joinleave_group', 'bp_dtheme_ajax_joinleave_group_social' );

/* AJAX close and keep closed site wide notices from an admin in the sidebar */
function bp_dtheme_ajax_close_notice_social() {
	global $userdata;
...
add_action( 'wp_ajax_messages_close_notice', 'bp_dtheme_ajax_close_notice_social' );

/* AJAX send a private message reply to a thread */
function bp_dtheme_ajax_messages_send_reply_social() {
	global $bp;
...
add_action( 'wp_ajax_messages_send_reply', 'bp_dtheme_ajax_messages_send_reply_social' );

/* AJAX mark a private message as unread in your inbox */
function bp_dtheme_ajax_message_markunread_social() {
	global $bp;
...
add_action( 'wp_ajax_messages_markunread', 'bp_dtheme_ajax_message_markunread_social' );

/* AJAX mark a private message as read in your inbox */
function bp_dtheme_ajax_message_markread_social() {
	global $bp;
...
add_action( 'wp_ajax_messages_markread', 'bp_dtheme_ajax_message_markread_social' );

/* AJAX delete a private message or array of messages in your inbox */
function bp_dtheme_ajax_messages_delete_social() {
	global $bp;
...
add_action( 'wp_ajax_messages_delete', 'bp_dtheme_ajax_messages_delete_social' );

/**
 * bp_dtheme_ajax_messages_autocomplete_results_social()
 *
 ...
 * @return none
 */
function bp_dtheme_ajax_messages_autocomplete_results_social() {
	global $bp;
...
add_action( 'wp_ajax_messages_autocomplete_results', 'bp_dtheme_ajax_messages_autocomplete_results_social' );
