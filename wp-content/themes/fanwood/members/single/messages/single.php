...
/**
 * BuddyPress - Single Member Single Message View
 *
 * This template is for reading and replying to messages.
 *
 * @package BuddyPress
 * @subpackage Theme
 */
...
<div id="message-thread" role="main" class="hentry">

	<?php do_action( 'bp_before_message_thread_content' ) ?>

		<?php if ( bp_thread_has_messages() ) : ?>

			<h2 class="entry-title" id="message-subject"><?php bp_the_thread_subject() ?></h2>
