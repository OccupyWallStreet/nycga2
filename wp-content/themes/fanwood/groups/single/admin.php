...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<div class="entry-content">
		...
		<p>
			<label for="group-desc"><?php _e( 'Group Description (required)', 'buddypress' ); ?></label><br />
		...
		<p class="submit"><input type="submit" value="<?php _e( 'Save Changes', 'buddypress' ) ?>" id="save" name="save" /></p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<div class="entry-content">
		...
		<p class="radio">
			<label><input type="radio" name="group-status" value="public"<?php bp_group_show_status_setting( 'public' ) ?> /> <strong><?php _e( 'This is a public group', 'buddypress' ) ?></strong></label>
		</p>
	...
	<div class="entry-content">
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<div class="avatar-crop">
				...
				<img src="<?php bp_avatar_to_crop() ?>" id="avatar-to-crop" class="avatar avatar-original" alt="<?php _e( 'Avatar to crop', 'buddypress' ) ?>" />
...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget manage-group manage-group-admins">
		...
		<h3 class="manage-group-title"><?php _e( 'Administrators', 'buddypress' ); ?></h3>
	...
	<div class="bp-widget manage-group manage-group-mods">
		...
		<h3 class="manage-group-title"><?php _e( 'Moderators', 'buddypress' ) ?></h3>		
	...
	<div class="bp-widget manage-group manage-group-members">
		...
		<h3 class="manage-group-title"><?php _e("Members", "buddypress"); ?></h3>
...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
	...
	<ul id="request-list" class="item-list dir-list">
		...
		<li>
			<div class="item-header">
				...
				<span class="activity"><?php bp_group_request_time_since_requested() ?>
			</div><!-- .item-header -->
