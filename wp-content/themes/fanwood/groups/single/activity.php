...
/**
 * BuddyPress - Single Group Activity
 *
 * @package BuddyPress
 * @subpackage Theme
 */
...
<?php if ( is_user_logged_in() && bp_group_is_member() ) : ?>
	...
	<?php locate_template( array( 'activity/post-form.php'), true ); // Loads the post-form.php template ?>
...
<div class="activity single-group" role="main">
	...
	<?php locate_template( array( 'activity/activity-loop.php' ), true ); // Loads the activity-loop.php template. ?>
