...
function upfw_default_header_links(){ ?>
				...
				<li class="support"><a href="http://wordpress.org/support/"><?php _e("Support","upfw"); ?></a></li>
				<li class="documentation"><a href="http://wplift.com/busby-free-wordpress-personal-blog-theme"><?php _e("Theme Documentation","upfw"); ?></a></li>
				 <?php	
