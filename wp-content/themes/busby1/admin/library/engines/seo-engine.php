...
function up_seo_default_options(){
    ...
    $options = array (
            ...
            array(	"name" => __('Disable the Busby Theme SEO?','upfw'),
            ...
            array(	"name" => __('Hide Custom Fields?','upfw'),
                            "desc" => __("If enabled, Busby Theme SEO options will not be displayed on posts/pages.",'upfw'),
...
function up_seo_meta_box() {
    ...
    if(!$up_options->seo_hide_custom_fields):
        if( function_exists( 'add_meta_box' ) ) {
            add_meta_box( 'new-post-meta-boxes', __('Busby Theme SEO Options'), 'up_seo_post_meta_display', 'post', 'normal', 'high' );
            add_meta_box( 'new-post-meta-boxes', __('Busby Theme SEO Options'), 'up_seo_post_meta_display', 'page', 'normal', 'high' );
        }
    endif;
}
