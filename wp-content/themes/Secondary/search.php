...
<div id="content">
<h2 class="pagetitle">Search <span>Result</span> for <?php /* Search Count */ $allsearch = &new WP_Query("s=$s&showposts=-1"); $key = wp_specialchars($s, 1); $count = $allsearch->post_count; _e(''); echo $key; _e(' &mdash; '); echo $count . ' '; _e('articles', 'ice'); wp_reset_query(); ?></small></h2>
