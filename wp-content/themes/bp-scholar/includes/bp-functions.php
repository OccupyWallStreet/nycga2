...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'bp-scholar' ),
		'accepted'          => __( 'Accepted', 'bp-scholar' ),
		'rejected'          => __( 'Rejected', 'bp-scholar' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'bp-scholar' ),
		'show_all'          => __( 'Show all', 'bp-scholar' ),
		'comments'          => __( 'comments', 'bp-scholar' ),
		'close'             => __( 'Close', 'bp-scholar' ),
		'view'              => __( 'View', 'bp-scholar' )
	);
