...
<div class="alignleft">
<big>Editing <strong>bp-group-calendar/groupcalendar/calendar.class.php</strong> (inactive)</big>
</div>
...
<div id="templateside">
	...
	<ul>
		<li class="highlight"><a href="plugin-editor.php?file=bp-group-calendar%2Fgroupcalendar%2Fcalendar.class.php&amp;plugin=bp-group-calendar%2Fgroupcalendar%2Fcalendar.class.php">bp-group-calendar/groupcalendar/calendar.class.php</a></li>
		<li><a href="plugin-editor.php?file=bp-group-calendar%2Fgroupcalendar%2Fbp-group-calendar.php&amp;plugin=bp-group-calendar%2Fgroupcalendar%2Fcalendar.class.php">bp-group-calendar/groupcalendar/bp-group-calendar.php</a></li>
		<li><a href="plugin-editor.php?file=bp-group-calendar%2Fgroupcalendar%2Fgroup_calendar.css&amp;plugin=bp-group-calendar%2Fgroupcalendar%2Fcalendar.class.php">bp-group-calendar/groupcalendar/group_calendar.css</a></li>
	</ul>
</div>
<form name="template" id="template" action="plugin-editor.php" method="post">
	<input type="hidden" id="_wpnonce" name="_wpnonce" value="c229e096ab" /><input type="hidden" name="_wp_http_referer" value="/wp-admin/network/plugin-editor.php?file=bp-group-calendar%2Fgroupcalendar%2Fcalendar.class.php&amp;plugin=bp-group-calendar%2Floader.php" />		<div><textarea cols="70" rows="25" name="newcontent" id="newcontent" tabindex="1">&lt;?php
/**
...
?&gt;</textarea>
		...
		<input type="hidden" name="file" value="bp-group-calendar/groupcalendar/calendar.class.php" />
		<input type="hidden" name="plugin" value="bp-group-calendar/groupcalendar/calendar.class.php" />
		<input type="hidden" name="scrollto" id="scrollto" value="0" />
		</div>
				<div id="documentation" class="hide-if-no-js"><label for="docs-list">Documentation:</label> <select name="docs-list" id="docs-list"><option value="">Function Name&hellip;</option><option value="abs">abs()</option><option value="date">date()</option><option value="date_i18n">date_i18n()</option><option value="htmlspecialchars">htmlspecialchars()</option><option value="in_array">in_array()</option><option value="is_array">is_array()</option><option value="is_null">is_null()</option><option value="is_numeric">is_numeric()</option><option value="str_pad">str_pad()</option><option value="strftime">strftime()</option><option value="strtolower">strtolower()</option><option value="strtotime">strtotime()</option><option value="substr">substr()</option><option value="ucwords">ucwords()</option></select> <input type="button" class="button" value="Lookup " onclick="if ( '' != jQuery('#docs-list').val() ) { window.open( 'http://api.wordpress.org/core/handbook/1.0/?function=' + escape( jQuery( '#docs-list' ).val() ) + '&amp;locale=en_US&amp;version=3.4.1&amp;redirect=true'); }" /></div>
				<p class="submit">
