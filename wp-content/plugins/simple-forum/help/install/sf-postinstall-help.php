...
if (preg_match('#' . basename(__FILE__) . '#', $_SERVER['PHP_SELF']))
{
	...
	sfa_paint_open_tab(__("SPF Installer", "sforum")." - ".__("SPF Install Complete", "sforum"));
		sfa_paint_open_panel();
			sfa_paint_open_fieldset(__("SPF Install Complete", "sforum"), false);
?>
        		<h2>Simple:Press version <?php echo(SFVERSION); ?> has been installed</h2>
            	<div class="clearboth"></div>

            	<div class="sfhelptext">
        			<h2>SOME IMPORTANT NOTES - PLEASE READ FIRST</h2>
