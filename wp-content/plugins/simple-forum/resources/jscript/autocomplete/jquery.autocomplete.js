jQuery.autocomplete = function(input, options) {
	...
	function onChange() {
 	...
 	function moveSelect(step) {
		...
		lis.removeClass("sfac_over");

		jQuery(lis[active]).addClass("sfac_over");
	...
	function selectCurrent() {
		var li = jQuery("li.sfac_over", results)[0];
		if (!li) {
	...
	function dataToDom(data) {
		...
		for (var i=0; i < num; i++) {
			...
			ul.appendChild(li);
			jQuery(li).hover(
				function() { jQuery("li", ul).removeClass("sfac_over"); jQuery(this).addClass("sfac_over"); active = jQuery("li", ul).indexOf(jQuery(this).get(0)); },
				function() { jQuery(this).removeClass("sfac_over"); }
...
jQuery.fn.autocomplete = function(url, options, data) {
	...
	options.inputClass = options.inputClass || "sfac_input";
	options.resultsClass = options.resultsClass || "sfac_results";
	...
	options.loadingClass = options.loadingClass || "sfac_loading";
