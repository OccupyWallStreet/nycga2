	...
	<div class="inner-sidebar">
		<div id="side-sortables" class="meta-box-sortables">
			...
			<div id="posttype" class="postbox">
				...
				<div class="inside" style="width:40%;float:left;">
				<p><b><?php _e('Status','wpematico'); ?></b></p>
				<?php
				...
				<div class="inside" style="width:42%;float:right;">
				<p><b><?php _e('Post type','wpematico'); ?></b></p>
				<?php
					$args=array(
					  'public'   => true
					); 
					...
					foreach ($post_types  as $post_type ) {
						echo '<input class="radio" type="radio" '.checked($post_type,$jobvalue['campaign_customposttype'],false).' name="campaign_customposttype" value="'. $post_type. '" id="customtype_'. $post_type. '" /> <label for="customtype_'. $post_type. '">'. $post_type. '</label><br />';
					}
				?>
				</div>
				<div id="major-publishing-actions">
					...
					<div id="publishing-action">
						<input type="submit" name="submit" disabled id="buttonsave" title="<?php _e('You must check feeds before save', 'wpematico'); ?>" class="button-primary right" accesskey="s" value="<?php _e('Save Changes', 'wpematico'); ?>" />
					</div>
					<div class="clear"></div>
				</div>
			</div>
