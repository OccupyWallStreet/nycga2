...
function GG_func_widget_weather_and_weather_forecast($args) {
  ...
  $info_text="<!--V4.0 rev005 *PID"." *ALoS".$opt_auto_location_select." *ALaS".$opt_auto_language_select." *L".$opt_language." *CSS".$opt_css_select." *Loc".$i_location_city.",".$i_location_state."*"."-->";
  ...
  if(!$gg_weather[0][99][3])
  {
          ...
          if($opt_language!="ar"){
            for($i=0;$i<=$i_days;$i++){$o_day_short[$i]=substr(GG_funx_translate_array($gg_weather[$i][0][3],$opt_language),0,3);}}
          else{
            for($i=0;$i<=$i_days;$i++){$o_day_short[$i]=substr($gg_weather[$i][0][3],0,3);}}                   
          ...
          if($gg_weather[0][11][3]>0 and $gg_weather[0][11][3]<=200 and GG_funx_translate_windspeed($gg_weather[0][11][3],"mph",$opt_language)!=""){
            $o_mo_actual=$o_mo_actual."".GG_funx_translate_array("Wind",$opt_language).": ".GG_funx_translate_windspeed($gg_weather[0][11][3+$flag_unit],$unit_speed,$opt_language)." (".$gg_weather[1][11][3+$flag_unit].$unit_speed.") ".GG_funx_translate_array("from",$opt_language)." ".GG_funx_translate_winddirections($gg_weather[0][11][1],$opt_language);
          ...
          if($gg_weather[0][16]!="" or ($gg_weather[0][17][0]!="" and $gg_weather[0][17][0]!="0")){
            ...
            if($gg_weather[0][17][0]!="" and $gg_weather[0][17][0]>0){
              $o_mo_actual=$o_mo_actual.$gg_weather[0][17][$flag_unit]."mm ";
            }
            $o_mo_actual=$o_mo_actual." - ";
          }
          ...
          if($opt_language=="en"){
            ...
            $o_actual_brief=GG_funx_translate_wetter_lang($gg_weather[0][2][3],$opt_language_index);
            }
          $o_mo_today=$o_day[1].": ";
              ...
              if($gg_weather[1][3][0]!="" or $gg_weather[1][4][0]!=""){
                ...
                if($gg_weather[1][11][3]>0 and $gg_weather[1][11][3]<=200 and GG_funx_translate_windspeed($gg_weather[1][11][3],"mph",$opt_language)!=""){
                  ...
                  if($gg_weather[1][17][0]!="" and $gg_weather[1][17][0]>0){
                    $o_mo_today=$o_mo_today.$gg_weather[1][17][$flag_unit]."mm ";
                  }
                }
              }
          } 
                  ...
                  if($gg_weather[$i][3][0]!="" or $gg_weather[$i][4][0]!=""){
                    ...
                    if($gg_weather[$i][16]!="" or ($gg_weather[$i][17][0]!="" and $gg_weather[$i][17][0]!="0"))  {
                        ...
                        if($gg_weather[$i][17][$flag_unit]!="" and $gg_weather[$i][17][0]>0){
                            $o_mo_fc[$i]=$o_mo_fc[$i].$gg_weather[$i][17][$flag_unit]."mm ";
                        }
                    }
                  }
              } 
   ...
   else
   {
    ...
    $content = str_replace(
        ...
        $o_mo_today, $o_temp_hi[1], $o_temp_lo[1], $o_back_img[1],$o_day[1].":",$o_day_short[1],$o_code_destructor[1],
...
function GG_func_widget_format($term_in,$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wun_licence_code,$term,$opt_hide_feels_like){
    ...
    if ($check=="small"){
      $term_out ="<!-- Table1 --><table  width='100%' cellpadding='0' cellspacing ='0'><tr><td><img src='%actual_icon_href%' alt='' style='float:right;' title='%o_mo_actual% %sunmoon_text%' %o_code_destructor_0%width='".round($i_size_l*93,0)."'><br /><p style='text-align:center'><span style='font-family:".$font_family."; font-size:".$f_size_l.";color:".$font_color."'>%o_actual_temp%</span><br />";
    ...
    if($check=="medium"){
      $term_out ="<!-- Table2 --><table width='100%' cellpadding='0' cellspacing ='0'><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_m.";color:".$font_color."'>%o_day_1% <br />%o_temp_hi_1%%o_degree_seperator%%o_temp_lo_1% </span></td><td><img src='%today_icon_href%' alt='' title='%o_mo_today%' %o_code_destructor_1%width='".round($i_size_m*61,0)."'></td></tr></table>";
    }    
    if($check=="large"){
      if($term=="checked"){$term_out ="<!-- Table 3 --><table  width='100%' cellpadding='0' cellspacing ='0'><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_2% </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_3% </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_4% </span></td></tr><tr><td></td><td></td><td></td></tr><tr><td><img src='%fc_2_icon_href%' alt='' %o_code_destructor_2%width='".round($i_size_s*31,0)."' title='%o_mo_fc_2%'></td><td><img src='%fc_3_icon_href%' alt='' %o_code_destructor_3%width='".round($i_size_s*31,0)."' title='%o_mo_fc_3%'></td><td> <img src='%fc_4_icon_href%' alt='' %o_code_destructor_4%width='".round($i_size_s*31,0)."' title='%o_mo_fc_4%'></td></tr><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_2%%o_degree_seperator%%o_temp_lo_2% </span> </td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_3%%o_degree_seperator%%o_temp_lo_3%  </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_4%%o_degree_seperator%%o_temp_lo_4% </span></td></tr></table>"; }
      else{$term_out ="<!-- Table 3 --><table  width='100%' cellpadding='0' cellspacing ='0'><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_2% </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_3% </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_4% </span></td></tr><tr><td></td><td></td><td></td></tr><tr><td><img src='%fc_2_icon_href%' alt='' %o_code_destructor_2%width='".round($i_size_s*31,0)."' title='%o_mo_fc_2%'></td><td><img src='%fc_3_icon_href%' alt='' %o_code_destructor_3%width='".round($i_size_s*31,0)."' title='%o_mo_fc_3%'></td><td> <img src='%fc_4_icon_href%' alt='' %o_code_destructor_4%width='".round($i_size_s*31,0)."' title='%o_mo_fc_4%'></td></tr><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_2%%o_degree_seperator%%o_temp_lo_2% </span> </td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_3%%o_degree_seperator%%o_temp_lo_3%  </span></td><td><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_temp_hi_4%%o_degree_seperator%%o_temp_lo_4% </span></td></tr>";       }
    }    
    if($check=="extended"){
      $term_out ="<!-- Table 4 --><table width='100%' cellpadding='0' cellspacing ='0'>";
      if($term=="large"){$term_out =$term_out."<tr><td colspan=5 style='font-family:".$font_family.";font-size:".$f_size_s."'>&nbsp;</td></tr>";}
      if($term!="large"){$term_out =$term_out."<tr><td colspan=8 style='font-family:".$font_family.";font-size:".$f_size_s."'>&nbsp;</td></tr><tr><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_short_2%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_short_3%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%o_day_short_4%</td>";}
      ...
      if($term!="large"){$term_out =$term_out."<td><img src='%fc_2_icon_href%'  alt='' width='".round($i_size_s*31*0.8,0)."' title='%o_mo_fc_2%'></td><td><img src='%fc_3_icon_href%'  alt='' width='".round($i_size_s*31*0.8,0)."' title='%o_mo_fc_3%'></td><td><img src='%fc_4_icon_href%' alt=''  %o_code_destructor_4%width='".round($i_size_s*31*0.8,0)."' title='%o_mo_fc_4%'></td>";}
      ...
      if($term!="large"){$term_out =$term_out."<td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_2%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_3%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_4%</td>";}
      $term_out =$term_out."<td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_5%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_6%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_7%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_8%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_hi_9%</td></tr><tr>"; 
      if($term!="large"){$term_out =$term_out."<td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_2%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_3%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_4%</td>";}
      $term_out =$term_out."<td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_5%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_6%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_7%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_8%</td><td style='font-family:".$font_family.";font-size:".round($f_size_s*0.8,0).";color:".$font_color."'>%o_temp_lo_9%</td></tr>";     
    }
    if($check=="large" or $check=="extended"){
      $term_out =$term_out."</table>";
    }      
    if($check=="link"){      
      $term_out ="<!-- Table 5 --><table width='100%' cellpadding='0' cellspacing ='0'><tr><td><br /><a href='%o_prmo_link_1%' target='_blank'><img src='%o_prmo_1%' alt=''  title='%o_prmo_link_1%'  %o_logo_destructor%height='25' ></a></td><td><br /><span style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>Data powered by</span></td><td><br /><a href='%o_prmo_link_0%' target='_blank'><img src='%o_prmo_0%' alt=''  title='%o_prmo_link_0%'  height='25'></a>&nbsp;</td></tr></table>";
    }    
    if($check=="lines"){
      $term_out ="<hr>"; 
    } 
