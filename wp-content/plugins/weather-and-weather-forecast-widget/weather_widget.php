...
Description: Sidebar widget with shortcode function in Arabic, English, French, German, Hungarian, Italian, Polish, Portuguese and Spanish to show either current weather and forecasts for ten days for any given location or the home location of your site visitors - detailled infotexts for current weather and forecasts on mouseover - multiple installation
...
function GG_func_widget_weather_and_weather_forecast_control() {    
    ...
    $widget_options = get_option('GG_func_widget_weather_and_weather_forecast');  	
  	if ( $_POST['weather_and_weather_forecast-submit'] ) {
  		...
  		$widget_options['opt_hide_na_select'] = stripslashes($_POST['weather_and_weather_forecast-opt_hide_na_select']);
      ...
      $f_size_l = htmlspecialchars($widget_options['f_size_l'], ENT_QUOTES);
  	  ...
  	  $opt_hide_na_select =  htmlspecialchars($widget_options['opt_hide_na_select'], ENT_QUOTES);
      ...
      if ($opt_lines=="yes"){
        $format_l1=GG_func_widget_format("lines",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      }
      if($opt_auto_location_select =="checked" or $opt_title_select=="checked"){
        $format_t0 = GG_func_widget_format("auto_location",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      }
      ...
      $format_t1 = GG_func_widget_format("small",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      if ($opt_layout=="medium" or $opt_layout=="large"){
        $format_t2=GG_func_widget_format("medium",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      }
      if ($opt_layout=="large"){
        $format_t3=GG_func_widget_format("large",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family,$font_color, $images,$wc_partnerid,$opt_day_night_images_select);
      }
      if ($opt_extended_forecast_select=="checked"){
        $format_t4=GG_func_widget_format("extended",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family,$font_color, $images,$wc_partnerid,$opt_layout);
      }
      if ($opt_link_to_weather_com == "yes")
      { $format_t5=GG_func_widget_format("link",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      }
       if ($opt_lines=="yes"){
        $format_l2=GG_func_widget_format("lines",$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,"");
      }
      if($opt_css_select == "checked") {  
        $format_c2= "</div>";
      }
    ...
    echo '</table>';
    echo '<table>';
    echo '<td><b>Technical Settings:</b></td><td>&nbsp;&nbsp;<a href="http://www.go-gadget-blog.com/gogadget/wp-content/uploads/Weather_and_Weather_Forecast_Widget_eng_3.0.pdf" target="_blank" style:"font-size:0.5em" title="Click for help!">Help!</a>&nbsp;&nbsp;<a href="http://www.go-gadget-blog.com/gogadget/wp-content/uploads/Weather_and_Weather_Forecast_Widget_ger_3.0.pdf" target="_blank" style:"font-size:0.5em" title="F&uuml;r Einstellungshilfe hier klicken!">Hilfe!</a></td>';
    echo '</table>';
    echo '<table>';
    echo '<tr><td><a title="Please enter your weather.com partner ID here!">Partner ID</a></td><td><a title="Please enter your weather.com license key here!">License Key</a></td><td colspan="4"><a title="Server will cache the weather for the entered time in seconds!">Cache</a> &nbsp;&nbsp;<a title="Enter a number of hours here to synchronize local with server time!">Serv.time</a></td></tr>';
    ...
    echo '</table>';
    echo '<table>';
    echo '<tr><td><a title="If using the Auto-location feature you might like to get a key from Ipinfodb to improve the results of geolocation. Enter it here!">(opt.)Ipinfo-Key</a>:</td><td><label><input style="width: 110px; " name="weather_and_weather_forecast-ipinfodb_key" type="text" value="'.$ipinfodb_key.'" /></label></td>';
    echo '<td>&nbsp;<a title="Enter a number of seconds here to stop your geolocation query, if the geolocation server doesnt respond! Increase if you are running your site on slow server!">Timeout</a></td>';
    echo '<td><label><input style="width: 30px;" name="weather_and_weather_forecast-timeout" type="text" value="'.$timeout.'" /></label></td>';
    echo '<td>sec&nbsp;</td></tr>';
    echo '</tr>';
    echo '</table>';
    echo '<table>';
    ...
    echo '<td><label><select style="width: 280px;" name="weather_and_weather_forecast-opt_language"></option><option value="ar" '.( ($opt_language == "ar") ? "selected=\"selected\" " : "" ).'>عربي(السعودية) (Arabic) </option><option value="de" '.( ($opt_language == "de") ? "selected=\"selected\" " : "" ).'>Deutsch (German) </option><option value="en" '.( ($opt_language == "en") ? "selected=\"selected\" " : "" ).'>English</option><option value="es" '.( ($opt_language == "es") ? "selected=\"selected\" " : "" ).'>Espa&ntilde;ol (Spanish)</option><option value="fr" '.( ($opt_language == "fr") ? "selected=\"selected\" " : "" ).'>Fran&ccedil;ais (French)</option><option value="it" '.( ($opt_language == "it") ? "selected=\"selected\" " : "" ).'>Italiano (Italian)</option><option value="hu" '.( ($opt_language == "hu") ? "selected=\"selected\" " : "" ).'>Magyar (Hungarian)</option><option value="pl" '.( ($opt_language == "pl") ? "selected=\"selected\" " : "" ).'>Polski (Polish)</option><option value="pt" '.( ($opt_language == "pt") ? "selected=\"selected\" " : "" ).'>Portugu&ecirc;s (Portuguese)</option></label>&nbsp;</td>';
    echo '</tr>';
    echo '</table>';
    echo '<table>';
    ...
    echo '<td>&nbsp;&nbsp;<input type="checkbox" name="weather_and_weather_forecast-opt_hide_na_select" value="checked" '.(($opt_hide_na_select=='checked')?'checked="checked"' : '').'"><a title="Check if you dont want to show actual conditions (temperature/pressure/etc) when weather report and image would show N/A">&nbsp;Hide N/A actuals</a></td></td></tr>';
    echo '</tr>';
    echo '</table>';
    echo '<table>'; 
...
function GG_func_widget_weather_and_weather_forecast($args) {
  ...
  $title_back = htmlspecialchars($widget_options['title_back'], ENT_QUOTES);
	...
	$opt_title_select = htmlspecialchars($widget_options['opt_title_select'], ENT_QUOTES);
  $opt_language = ($opt_language == "de" || $opt_language == "en" || $opt_language == "fr" || $opt_language == "es" || $opt_language == "it" || $opt_language == "pl" || $opt_language == "hu" || $opt_language == "pt" || $opt_language == "ar"    ) ? $opt_language : "en";
  $opt_language_2="";
  ...
  if($opt_language_2 == "de" || $opt_language_2 == "en" || $opt_language_2 == "fr" || $opt_language_2 == "es" || $opt_language_2 == "it" || $opt_language_2 == "pl" || $opt_language_2 == "hu" || $opt_language_2 == "pt" || $opt_language_2 == "ar"){$opt_language=$opt_language_2;}
  ...
  $info_text="<!--V2.2 *PID".$wc_partnerid." *ALoS".$opt_auto_location_select." *ALaS".$opt_auto_language_select." *L".$opt_language." *CSS".$opt_css_select." *Loc".$wc_location."*"."-->";
  if($opt_auto_location_select=="checked"){
    list($flag_search,$search_string,$country_code) = GG_func_get_ip_data($ipinfodb_key,$timeout);
    ...
    if($flag_search=="Yes"){
      ...
      if($loc_id!=""){  
        if($opt_language!="en"){$loc_state=GG_funx_translate_statename(strtolower($country_code),$opt_language_index);}
  ...
  $data = GG_func_get_content($uri);
    if ($data === false){
      ...
      if($unit_pressure=="mb"){$unit_pressure="mbar";}
    ...
    for($i=4;$i<10;$i++){   //get icons for extended forecast
      $icon_day[$i]=$icon_day[3];          
      $term_out=GG_funx_get_weather_icon_extended($cond_day_text[$i][0]);
      if($term_out!=$icon_day[$i] and $term_out!=""){
        $icon_day[$i]=$term_out;
      }      
      if($imagefolder_check=="WeatherCom"){
        $iconhref_day[$i] = $imageloc.$imagefolder."31/".$icon_day[$i].'.png';}
        else{
          $iconhref_day[$i] = $imageloc.$imagefolder.$icon_day[$i].'.png';
        }
    }                     
    if ($opt_language == "ar")  //Translate text for actual weatherconditions to arabic - text for mouseover on actual main icon
    {
           $day[0]="اليوم";
           ...
           if ($flag_cc!= "N/A"){
           $feels_lang="الشعور وكأنه";
           }
           else
           {
           $feels_lang="عذراً.. لاتوجد بيانات متوفره حالياً!";
           }                 
          $term_out_flag_4='';         
           for($j=0; $j<=3;$j++){ 
            $term_out="";
           ...
           $cond_day_lang[$j]=$cond_day_lang[$j]." - هطول: ".$ppcp_day[$j]; 
           if($cond_day_text[$j][17]!="")
           {  if($cond_day_text[$j][18]=="")
              {  $cond_day_lang[$j]=$cond_day_lang[$j]." (حول. ".GG_funx_translate_inch($cond_day_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
              { $cond_day_lang[$j]=$cond_day_lang[$j]." (حول. ".GG_funx_translate_inch($cond_day_text[$j][17],$opt_unit)." إلى ".GG_funx_translate_inch($cond_day_text[$j][18],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
           }                    
           ...
           $cond_night_lang[$j]=$cond_night_lang[$j]."  - هطول: ".$ppcp_night[$j];
           if($cond_night_text[$j][17]!="")
           {  if($cond_night_text[$j][18]=="")
              {  $cond_night_lang[$j]=$cond_night_lang[$j]." (حول. ".GG_funx_translate_inch($cond_night_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
              { $cond_night_lang[$j]=$cond_night_lang[$j]." (حول. ".GG_funx_translate_inch($cond_night_text[$j][17],$opt_unit)." إلى ".GG_funx_translate_inch($cond_night_text[$j][18],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
           }
          ...
          for ($i=0;$i<=3;$i++){
            ...
            if ($term_out!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." - ".$term_out." منذ ".GG_funx_translate_winddirections($wind_directions_day[$i],$opt_language);}
            $term_out=GG_funx_translate_windspeed($wind_speed_night[$i],$unit_speed,$opt_language);
            if ($term_out!=""){$cond_night_lang[$i]=$cond_night_lang[$i]." - ".$term_out." منذ ".GG_funx_translate_winddirections($wind_directions_night[$i],$opt_language);} 
          }          
          for ($i=0;$i<=3;$i++){
            $cond_day_lang[$i]="نهاراً:".$cond_day_lang[$i]; 
            $cond_night_lang[$i]="ليلاً:".$cond_night_lang[$i];
          }             
          $icon_string_lang="الشروط الفعلية - ";  
          $pressure_lang=GG_funx_translate_pressure($pressure,$unit_pressure,$opt_language);          
          $pressure = $pressure.$unit_pressure;
          if ($pressure_lang!=""){$icon_string_lang=$icon_string_lang.$pressure_lang."";}
          else
          { $icon_string_lang=$icon_string_lang."";}
          $icon_string_lang=$icon_string_lang."الضغط: ".$pressure;
          ...
          if ($windspeed!="CALM" and $windspeed!="calm")
            {
            $icon_string_lang=$icon_string_lang." - رياح: ".$windspeed.$unit_speed.$fill_in.GG_funx_translate_windspeed($windspeed,$unit_speed,$opt_language).$fill_out." aus ".GG_funx_translate_winddirections($winddirections_description,$opt_language);
            }
          else
            {
            $icon_string_lang=$icon_string_lang." - الرياح: هادئه";
            }
          $icon_string_lang=$icon_string_lang." - رطوبة: ".$humidity;
          $icon_string_lang=$icon_string_lang." - الأشعة فوق البنفسجية: ".$uv_index." (".GG_funx_translate_uvindex($uv_index,$opt_language_index).") - ";          
          $sunmoon_string_lang="شروق الشمس في".$sunrise." ساعات";
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "ليلاً"){$sunmoon_string_lang=$sunmoon_string_lang." (في ".$night_left."س) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - غروب الشمس في ".$sunset." ساعات"; 
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "نهاراً"){$sunmoon_string_lang=$sunmoon_string_lang." (في ".$daylight_left."س) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - طول اليوم: ".$daylight_time."h - المرحلة القمرية ".GG_funx_translate_moonphase_lang($moonphase,$opt_language_index);
          ...
          {$cond_day_lang[$i]="لا توجد بيانات لهذا اليوم!";}
          ...
          if($cond_day_text[$i][12]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * الرياح: ".GG_funx_translate_windspeed(1/2*($cond_day_text[$i][12]+$cond_day_text[$i][13]),"mph",$opt_language)." من ".$cond_day_text[$i][14];}
          if($cond_day_text[$i][15]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." *  فرصة لـ  ".GG_funx_translate_array($cond_day_text[$i][15],$opt_language).": ".$cond_day_text[$i][16]."%";}
          }
       for($i=1;$i<9;$i++){$day_ext[$i]="";}
        ...
        $extended_forecast="التوقعات:"; 
                 
    }      //end translation to Arabic
    if ($opt_language == "de")  //Translate text for actual weatherconditions to german - text for mouseover on actual main icon
    {
          ...
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "night"){$sunmoon_string_lang=$sunmoon_string_lang." (in ".$night_left."h) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - Sonnenuntergang um ".$sunset." Uhr"; 
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "day"){$sunmoon_string_lang=$sunmoon_string_lang." (in ".$daylight_left."h) ";}}
    ...
    if ($opt_language == "fr")     //Translate text for actual weatherconditions to French - text for mouseover on actual main icon
    {
          ...
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "night"){$sunmoon_string_lang=$sunmoon_string_lang." (en ".$night_left."h) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - Coucher du soleil ".$sunset." h "; 
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "day"){$sunmoon_string_lang=$sunmoon_string_lang." (en ".$daylight_left."h) ";}}
     ...
     if ($opt_language == "hu")
    {
           ...
           for($j=2;$j<=9;$j++){$day[$j]=GG_funx_translate_array($day[$j],$opt_language);}        
           if ($flag_cc!= "N/A"){
            $feels_lang="&eacute;rz&eacute;sre";
           }
           else
           {
            $feels_lang="Eln&eacute;z&eacute;st! Nincs el&eacute;rhet&#337; aktu&aacute;lis id&#337;j&aacute;r&aacute;s-jelent&eacute;s!";
           }          
           for($j=0; $j<=3;$j++){ 
            $term_out="";
            $term_array = explode(" ",$cond_day[$j]);
           ...
           $cond_day_lang[$j]=$cond_day_lang[$j]." &bull; a csapad&eacute;k val&oacute;sz&iacute;n&#369;s&eacute;ge: ".$ppcp_day[$j]; 
           if($cond_day_text[$j][17]!="")
           {  if($cond_day_text[$j][18]=="")
              {  $cond_day_lang[$j]=$cond_day_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_day_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
              { $cond_day_lang[$j]=$cond_day_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_day_text[$j][17],$opt_unit)." &bull; ".GG_funx_translate_inch($cond_day_text[$j][18],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
           }
           $cond_day_lang[$j]=str_replace("xx>","",$cond_day_lang[$j]);
           $cond_day_lang[$j]=str_replace("xxf","",$cond_day_lang[$j]);
           }          
           ...
           for ($i=0; $i<count($term_array);$i++){
            ...
            $cond_night_lang[$j]=$cond_night_lang[$j]." &bull; a csapad&eacute;k val&oacute;sz&iacute;n&#369;s&eacute;ge: ".$ppcp_night[$j];
            if($cond_night_text[$j][17]!="")
           {  if($cond_night_text[$j][18]=="")
              {  $cond_night_lang[$j]=$cond_night_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_night_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
              { $cond_night_lang[$j]=$cond_night_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_night_text[$j][17],$opt_unit)." &bull; ".GG_funx_translate_inch($cond_night_text[$j][18],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
           }
          $cond_night_lang[$j]=str_replace("xx>","",$cond_night_lang[$j]);
           $cond_night_lang[$j]=str_replace("xxf","",$cond_night_lang[$j]);                 
           }          
          ...
          if(strlen($wind_directions_night[$i])==2){$wind_directions_night[$i]=$wind_directions_night[$i]."X";} 
          $term_out=GG_funx_translate_windspeed($wind_speed_day[$i],$unit_speed,$opt_language);
          if ($term_out!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." &bull; ".preg_replace('/(\s.*)$/'," ".GG_funx_translate_winddirections($wind_directions_day[$i],$opt_language)."$1",$term_out);}
          $term_out=GG_funx_translate_windspeed($wind_speed_night[$i],$unit_speed,$opt_language);
          if ($term_out!=""){$cond_night_lang[$i]=$cond_night_lang[$i]." &bull; ".preg_replace('/(\s.*)$/'," ".GG_funx_translate_winddirections($wind_directions_night[$i],$opt_language)."$1",$term_out);} 
          }          
          for ($i=0;$i<=3;$i++){
          $cond_day_lang[$i]="Nappal:".preg_replace('/\s\/\s/',"/",$cond_day_lang[$i]); 
          $cond_night_lang[$i]="&Eacute;jszaka:".preg_replace('/\s\/\s/',"/",$cond_night_lang[$i]);
          }             
          ...
          if ($windspeed!="CALM" and $windspeed!="calm")
            {
            $icon_string_lang=$icon_string_lang." &bull; sz&eacute;l: ".$windspeed."&nbsp;".$unit_speed; $separator = ", "; if (GG_funx_translate_windspeed($windspeed,$unit_speed,$opt_language)=="") $icon_string_lang.=$separator.GG_funx_translate_winddirections($winddirections_description,$opt_language); else {if ($winddirections_description == "VAR") $icon_string_lang.=$separator.GG_funx_translate_winddirections($winddirections_description,$opt_language); else $icon_string_lang.=$separator.preg_replace('/(\s.*)$/'," ".GG_funx_translate_winddirections($winddirections_description,$opt_language)." $1",GG_funx_translate_windspeed($windspeed,$unit_speed,$opt_language));}
            }
          else
            {
            $icon_string_lang=$icon_string_lang." &bull; sz&eacute;lcsend";
            }
          $icon_string_lang=$icon_string_lang." &bull; p&aacute;ratartalom: ".$humidity;
          $icon_string_lang=$icon_string_lang." &bull; UV-index: ".$uv_index." (".GG_funx_translate_uvindex($uv_index,$opt_language_index).") &bull; ";          
          $sunmoon_string_lang="napkelte: ".$sunrise."&nbsp;h "; $it_is_now="most";
          if($opt_auto_location_select<>"checked"){if ($flag_day_night == "night"){$night_left != "00:00" ? $sunmoon_string_lang=$sunmoon_string_lang." (".$night_left."&nbsp;h m&uacute;lva) " : $sunmoon_string_lang=$sunmoon_string_lang." (most) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." &bull; napnyugta: ".$sunset."&nbsp;h "; 
          if($opt_auto_location_select<>"checked"){if ($flag_day_night == "day"){$daylight_left != "00:00" ? $sunmoon_string_lang=$sunmoon_string_lang." (".$daylight_left."&nbsp;h m&uacute;lva) " : $sunmoon_string_lang=$sunmoon_string_lang." (most) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." &bull; a nap hossza: ".$daylight_time."&nbsp;h &bull; holdf&aacute;zis: ".GG_funx_translate_moonphase_lang($moonphase,$opt_language_index);
          $wetterlang=GG_funx_translate_wetter_lang($icon,$opt_language_index);
          $j=1;
          if($opt_layout=="large" ){$j=4;}
          for($i=$j;$i<count($day);$i++)
          ...
          {$cond_day_lang[$i]="Eln&eacute;z&eacute;st! Nincs el&eacute;rhet&#337; aktu&aacute;lis id&#337;j&aacute;r&aacute;s!";}
          if($cond_day_text[$i][11]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * ".GG_funx_translate_fahrenheit($cond_day_text[$i][11],$opt_unit);}
          if($cond_day_text[$i][10]!="" and $cond_day_text[$i][10]<>$cond_day_text[$i][11]){$cond_day_lang[$i]=$cond_day_lang[$i]."/".GG_funx_translate_fahrenheit($cond_day_text[$i][10],$opt_unit)." ";}
          if($cond_day_text[$i][12]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * sz&eacute;l: ".GG_funx_translate_windspeed(1/2*($cond_day_text[$i][12]+$cond_day_text[$i][13]),"mph",$opt_language)." ".$cond_day_text[$i][14];}
          if($cond_day_text[$i][15]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * val&oacute;sz&iacute;n&#369;s&eacute;ge ".GG_funx_translate_array($cond_day_text[$i][15],$opt_language).": ".$cond_day_text[$i][16]."%";}
          }
      for($i=1;$i<9;$i++){$day_ext[$i]="";}
      for($i=4;$i<count($day);$i++){$day_ext[$i]=substr($day[$i],0,3);}
      $day_ext[1]=substr($day_old,0,3);
      $day_ext[2]=substr($day[2],0,3);
      $day_ext[3]=substr($day[3],0,3);
      $extended_forecast="El&#337;rejelz&eacute;s:";
     ...
     if ($opt_language == "it")
    {
          ...
          {$cond_day_lang[$i]="Perdón! Datos del tiempo no disponibles!";}
          if($cond_day_text[$i][11]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * ".GG_funx_translate_fahrenheit($cond_day_text[$i][11],$opt_unit);}
          if($cond_day_text[$i][10]!="" and $cond_day_text[$i][10]<>$cond_day_text[$i][11]){$cond_day_lang[$i]=$cond_day_lang[$i]."/".GG_funx_translate_fahrenheit($cond_day_text[$i][10],$opt_unit)." ";}
          if($cond_day_text[$i][12]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * Viento: ".GG_funx_translate_windspeed(1/2*($cond_day_text[$i][12]+$cond_day_text[$i][13]),"mph",$opt_language)." from ".$cond_day_text[$i][14];}
    ...
    if ($opt_language == "pl")
    {
          ...
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "night"){$sunmoon_string_lang=$sunmoon_string_lang." (za ".$night_left."h) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - Zach&#243;d S&#322;o&#324;ca o godz. ".$sunset." "; 
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "day"){$sunmoon_string_lang=$sunmoon_string_lang." (za ".$daylight_left."h) ";}}
        ...
        if ($opt_language == "pt")
    {
           ...
           for($j=2;$j<=9;$j++){$day[$j]=GG_funx_translate_array($day[$j],$opt_language);}        
           if ($flag_cc!= "N/A"){
            $feels_lang="Sensa&ccedil;&atilde;o T&eacute;rmica";
           }
           else
           {
            $feels_lang="Sinto Muito!&nbsp;Dados meteorol&oacute;gicos n&atilde;o dispon&iacute;vel!";
           }          
           for($j=0; $j<=3;$j++){ 
            $term_out="";
            $term_array = explode(" ",$cond_day[$j]);
           ...
           $cond_day_lang[$j]=$cond_day_lang[$j]." - Precipita&ccedil;&atilde;o: ".$ppcp_day[$j];
           if($cond_day_text[$j][17]!="")
           {  if($cond_day_text[$j][18]=="")
              {  $cond_day_lang[$j]=$cond_day_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_day_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
          ...
          $cond_night_lang[$j]=$cond_night_lang[$j]."  - Precipita&ccedil;&atilde;o: ".$ppcp_night[$j];
          if($cond_night_text[$j][17]!="")
           {  if($cond_night_text[$j][18]=="")
              {  $cond_night_lang[$j]=$cond_night_lang[$j]." (&asymp;".GG_funx_translate_inch($cond_night_text[$j][17],$opt_unit)." ".GG_funx_translate_array($cond_day_text[$j][15],$opt_language).")";}
              else
          ...
          for ($i=0;$i<=3;$i++){
          $cond_day_lang[$i]="Dia: ".$cond_day_lang[$i]; 
          $cond_night_lang[$i]="Noiche: ".$cond_night_lang[$i];
          }             
          $icon_string_lang="Agora - ";  
          $pressure_lang=GG_funx_translate_pressure($pressure,$unit_pressure,$opt_language);          
          $pressure = $pressure.$unit_pressure;
          if ($pressure_lang!=""){$icon_string_lang=$icon_string_lang.$pressure_lang."p";}
          else
          { $icon_string_lang=$icon_string_lang."P";}
          $icon_string_lang=$icon_string_lang."ress&atilde;o: ".$pressure;
          if ($pressuretendence!="steady" and $pressuretendence!="N/A"){$icon_string_lang=$icon_string_lang." (".GG_funx_translate_array($pressuretendence,$opt_language).")";}
          if (GG_funx_translate_windspeed($windspeed,$unit_speed,$opt_language)!="") {$fill_in=" (";$fill_out=")";}
          if ($windspeed!="CALM" and $windspeed!="calma")
            {
            $icon_string_lang=$icon_string_lang." - Vento: ".$windspeed.$unit_speed.$fill_in.GG_funx_translate_windspeed($windspeed,$unit_speed,$opt_language).$fill_out." de ".GG_funx_translate_winddirections($winddirections_description,$opt_language);
            }
          else
            {
            $icon_string_lang=$icon_string_lang." - Vento: Calma";
            }
          $icon_string_lang=$icon_string_lang." - Umidade: ".$humidity;
          $icon_string_lang=$icon_string_lang." - &Iacute;ndice UV: ".$uv_index." (".GG_funx_translate_uvindex($uv_index,$opt_language_index).") - ";          
          $sunmoon_string_lang="Amanhecer: ".$sunrise." h ";
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "night"){$sunmoon_string_lang=$sunmoon_string_lang." (en ".$night_left."h) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - P&ocirc;r do sol ".$sunset." h "; 
          if($opt_auto_location_select<>"checked" and !$args['flag']){if ($flag_day_night == "day"){$sunmoon_string_lang=$sunmoon_string_lang." (en ".$daylight_left."h) ";}}
          $sunmoon_string_lang=$sunmoon_string_lang." - Dura&ccedil;&atilde;o do dia : ".$daylight_time."h - Fases da lua: ".GG_funx_translate_moonphase_lang($moonphase,$opt_language_index);
          $wetterlang=GG_funx_translate_wetter_lang($icon,$opt_language_index);
          $j=1;           //create extended forecast
          if($opt_layout=="large" ){$j=4;}
          for($i=$j;$i<count($day);$i++)
          ...
          {$cond_day_lang[$i]="Sinto Muito!&nbsp;Dados meteorol&oacute;gicos n&atilde;o dispon&iacute;vel!";}
          if($cond_day_text[$i][11]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * ".GG_funx_translate_fahrenheit($cond_day_text[$i][11],$opt_unit);}
          if($cond_day_text[$i][10]!="" and $cond_day_text[$i][10]<>$cond_day_text[$i][11]){$cond_day_lang[$i]=$cond_day_lang[$i]."/".GG_funx_translate_fahrenheit($cond_day_text[$i][10],$opt_unit)." ";}
          if($cond_day_text[$i][12]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * Vento: ".GG_funx_translate_windspeed(1/2*($cond_day_text[$i][12]+$cond_day_text[$i][13]),"mph",$opt_language)." from ".$cond_day_text[$i][14];}
          if($cond_day_text[$i][15]!=""){$cond_day_lang[$i]=$cond_day_lang[$i]." * Probabilidade de ".GG_funx_translate_array($cond_day_text[$i][15],$opt_language).": ".$cond_day_text[$i][16]."%";}
          }
      for($i=1;$i<9;$i++){$day_ext[$i]="";}
      for($i=4;$i<count($day);$i++){
        $n=3;
    ...
    if($imagefolder_check=="WeatherCom"){$iconhref = $imageloc.$imagefolder."93/".$icon.'.png';}
		...
		$hide_table_1=0;
    if($icon=="44" or $icon=="25" or $icon==""){
      if($opt_hide_na_select=="checked"){
      $hide_table_1=1;
      } 
    }
    ...
    //echo "Halt!";
      ...
      //echo htmlspecialchars($format, ENT_QUOTES); 
    }
    $content = str_replace(
			array (
        ...
        "%iconhref_day_4%","%iconhref_day_5%","%iconhref_day_6%", "%iconhref_day_7%","%iconhref_day_8%","%iconhref_day_9%",
        ...
        "%cond_night_lang_0%", "%cond_night_lang_1%", "%cond_night_lang_2%", "%cond_night_lang_3%","%sc_title%",  
        "%day_ext_1%","%day_ext_2%","%day_ext_3%","%day_ext_4%","%day_ext_5%","%day_ext_6%","%day_ext_7%","%day_ext_8%","%day_ext_9%","%extendend_forecast%", "%icon_layout_middle_check%","%auto_loc%","%info_text%"
			) ,
			array (
				$loc, $temp, $feels, $cond, $icon, $iconhref, $icon_string_lang,  $wetterlang, $feels_lang,
        ...
        $iconhref_day["4"], $iconhref_day["5"], $iconhref_day["6"], $iconhref_day["7"],$iconhref_day["8"], $iconhref_day["9"],         
        ...
        $cond_night_lang["0"], $cond_night_lang["1"],$cond_night_lang["2"],$cond_night_lang["3"],$sc_title,  
        $day_ext["1"],$day_ext["2"],$day_ext["3"],$day_ext["4"],$day_ext["5"],$day_ext["6"],$day_ext["7"],$day_ext["8"],$day_ext["9"], $extended_forecast, $icon_layout_middle_check,$auto_loc,$info_text,     
			) ,
			$format
		);
    if ($data === false){
     $content = str_replace(
        ...
        "%icon_ext_1%","%icon_ext_2%","%icon_ext_3%","%icon_ext_4%","%icon_ext_5%","%icon_ext_6%", 
         ...
         $imageloc.'1x1.gif', $imageloc.'1x1.gif',$imageloc.'1x1.gif', $imageloc.'1x1.gif',  $imageloc.'1x1.gif', $imageloc.'1x1.gif',
         "", "", "", "", "", "",  "", "",
			) ,
			$format
		);
    }		
		//$content=GG_func_convertLatinToHtml($content);
...
function GG_func_widget_format($term_in,$term_out,$f_size_s,$f_size_m,$f_size_l,$i_size_s,$i_size_m,$i_size_l,$background_color,$font_family, $font_color, $images,$wc_partnerid,$term){
    ...
    if ($check=="auto_location"){
      $term_out ="<!-- Table0 --><table width='100%' cellpadding='0' cellspacing ='0'><tr><td>&nbsp;</td></tr><tr><td><span style='font-family:".$font_family.";font-size:".$f_size_l.";color:".$font_color."'>%auto_loc%</span></td></tr></table>";
    }   
    if ($check=="small"){
    ...
    if($check=="extended"){
      ...
      if($term=="large"){$term_out =$term_out."<tr><td colspan=6 style='font-family:".$font_family.";font-size:".$f_size_s."'>&nbsp;</td></tr>";}
      if($term!="large"){$term_out =$term_out."<tr><td colspan=9 style='font-family:".$font_family.";font-size:".$f_size_s."'>&nbsp;</td></tr><tr><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_1%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_2%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_3%</td>";}
      $term_out =$term_out."<td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_4%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_5%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_6%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_7%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_8%</td><td style='font-family:".$font_family.";font-size:".$f_size_s.";color:".$font_color."'>%day_ext_9%</td></tr><tr>"; 
      if($term!="large"){$term_out =$term_out."<td><img src=%iconhref_day_1% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_1% *** %cond_night_lang_1%'></td><td><img src=%iconhref_day_2% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_2% *** %cond_night_lang_2%'></td><td><img src=%iconhref_day_3% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_3% *** %cond_night_lang_3%'></td>";}
      $term_out =$term_out."<td><img src=%iconhref_day_4% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_4%'></td><td><img src=%iconhref_day_5% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_5%'></td><td><img src=%iconhref_day_6% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_6%'></td><td><img src=%iconhref_day_7% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_7%'></td><td><img src=%iconhref_day_8% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_8%'></td><td><img src=%iconhref_day_9% width='".round($i_size_s*31*0.8,0)."' title='%cond_day_lang_9%'></td></tr></table>";
    ...
    if ($check=="sc_small"){     
      ...
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:100%>%wetterlang%</span></td></tr></table></div>";
      }
      else{
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:100%>%wetterlang%</span></td><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td></tr></table></div>";
      }
    }
    
    if ($check=="sc_header"){     
      if($term=="Yes" or $term=="yes"){
      $term_out ="<div id='gogadget_weather_widget_sc_header' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan=3><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td><td><span style=font-size:110%>%sc_title%</span><br /><span style=font-size:100%>%temp%</span><br /><span style=font-size:100%>%wetterlang%</span></td></tr></table></div>";
      }
      else{
      $term_out ="<div id='gogadget_weather_widget_sc_header' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td><span style=font-size:110%>%sc_title%</span><span style=font-size:100%>%temp%</span><br /><span style=font-size:100%>%wetterlang%</span></td><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td></tr></table></div>";
      }
    }
    ...
    if ($check=="sc_today"){
      ...
      $term_out=$term_out."<tr><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_l."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td></tr></table></div>";   
     
      }
      else{
        $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr>";
      $term_out=$term_out."<tr><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_l."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td></tr></table></div>";
    ...
    if ($check=="sc_middle"){
      if($term=="Yes" or $term=="yes"){
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:80%> %feels_lang%  %feels%</span><br /><span style=font-size:100%>%wetterlang%</span></td></tr>";
      $term_out=$term_out."<tr><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_m."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td></tr></table></div>";
      }
      else{
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:80%> %feels_lang%  %feels%</span><br /><span style=font-size:100%>%wetterlang%</span></td><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td></tr>";
      $term_out=$term_out."<tr><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_m."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td></tr></table></div>";
      }
    }
    ...
    if ($check=="sc_large"){
      if($term=="Yes" or $term=="yes"){
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:80%> %feels_lang%  %feels%</span><br /><span style=font-size:100%>%wetterlang%</span></td></tr>";
      $term_out=$term_out."<tr><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_m."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td></tr>";
      }
      else{
      $term_out ="<div id='gogadget_weather_widget_sc' ><!-- Table1 --><table style = 'float:".$term_out."'><tr><td colspan = 3><span style=font-size:110%>%sc_title%</span></td></tr><tr><td><span style=font-size:100%>%temp%</span><br /><span style=font-size:80%> %feels_lang%  %feels%</span><br /><span style=font-size:100%>%wetterlang%</span></td><td colspan=2><img src='%iconhref%' alt='%cond%'  title='%icon_string_lang% %sunmoon_string_lang%' width='".$i_size_l."'></td></tr>";
      $term_out=$term_out."<tr><td>%day_0%: <br />%temp_hi_0% / %temp_lo_0%</td><td colspan=2><img src=%iconhref_day_0% title='%cond_day_lang_0%' %icon_layout_middle_check%width='".$i_size_m."'><img src=%iconhref_night_0% width='".$i_size_m."' title='%cond_night_lang_0%'></td></tr>";
      } 
      $term_out=$term_out."<tr><td><span style='font-size:80%'>%day_1% </span></td><td><span style='font-size:80%'>%day_2% </span></td><td><span style='font-size:80%'>%day_3% </span></td></tr><tr><td><img src=%iconhref_day_1% width='".$i_size_s."' title='%cond_day_lang_1% *** %cond_night_lang_1%'></td><td><img src=%iconhref_day_2% width='".$i_size_s."' title='%cond_day_lang_2% *** %cond_night_lang_2%'></td><td> <img src=%iconhref_day_3% width='".$i_size_s."' title='%cond_day_lang_3% *** %cond_night_lang_3%'></td></tr><tr><td><span style='font-size:80%'>%temp_hi_1% / %temp_lo_1% </span> </td><td><span style='font-size:80%'>%temp_hi_2% / %temp_lo_2%  </span></td><td><span style='font-size:80%'>%temp_hi_3% / %temp_lo_3% </span></td></table></div>";
    }        
