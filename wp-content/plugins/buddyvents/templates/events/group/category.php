...
if( bpe_has_events() ) : ?>
	...
	<h4><?php printf( __( 'Category: %s', 'events' ), ucwords( bp_action_variable( 1 ) ) ) ?></h4>

    <?php do_action( 'bpe_group_cat_before_loop' ) ?>
    ...
    <?php do_action( 'bpe_group_cat_inside_loop' ) ?>
	
	</ul>
    
    <?php do_action( 'bpe_group_cat_after_loop' ) ?>
