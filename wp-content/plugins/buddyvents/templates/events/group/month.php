...
if( bpe_has_events() ) : ?>
	...
	<h4><?php printf( __( 'Month: %s %s', 'events' ), mysql2date( 'F', bp_action_variable( 2 ) .'-'. bp_action_variable( 1 ), true ), bp_action_variable( 2 ) ) ?></h4>

    <?php do_action( 'bpe_group_month_before_loop' ) ?>
    ...
    <?php do_action( 'bpe_group_month_inside_loop' ) ?>
	
	</ul>

    <?php do_action( 'bpe_group_month_after_loop' ) ?>
