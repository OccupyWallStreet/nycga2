<?php
/* Originaly from Twenty Eleven Custom Headers Code */
...
define( 'HEADER_IMAGE_WIDTH', apply_filters( 'twentyeleven_header_image_width', 756 ) );
define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyeleven_header_image_height', 200 ) );

// Add a way for the custom header to be styled in the admin panel that controls
// custom headers. See twentyeleven_admin_header_style(), below.
add_custom_image_header( '', 'twentyeleven_admin_header_style', 'twentyeleven_admin_header_image' );
