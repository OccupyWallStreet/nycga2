Files in this folder or in yourthemedir/plugins/events-manager/formats/ would be used to replace formatting options in the settings page. This allows you a much greater degree of flexibility as you can use PHP go do all sorts of customizations to your events.
...
function my_em_custom_formats( $array ){
	$my_formats = array('dbem_event_list_item_format');
