...
?>
<h3 class="pagetitle">
	<?php printf( __( 'Timezone: %s', 'events' ), bpe_get_config( 'timezones', bp_action_variable( 0 ) ) ) ?><?php if( ! bpe_is_restricted() ) : ?>&nbsp;<a class="button" href="<?php echo bp_get_root_domain() . '/' . bpe_get_base( 'root_slug' ) . '/'. bpe_get_option( 'create_slug' ) ?>"><?php _e( 'Create Event', 'events' ) ?></a><?php endif; ?>
</h3>
