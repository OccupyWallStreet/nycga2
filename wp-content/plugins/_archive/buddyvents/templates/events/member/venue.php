...
if( bpe_has_events() ) : ?>
	...
	<h4><?php printf( __( 'Venue: %s', 'events' ), bpe_get_config( 'venues', bp_action_variable( 0 ) ) ) ?></h4>

    <?php do_action( 'bpe_member_venue_before_loop' ) ?>
    ...
    <?php do_action( 'bpe_member_venue_inside_loop' ) ?>
	
	</ul>
    
    <?php do_action( 'bpe_member_venue_after_loop' ) ?>
