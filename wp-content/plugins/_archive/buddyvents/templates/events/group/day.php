...
if( bpe_has_events() ) : ?>
	...
	<h4 class="pagetitle"><?php printf( __( 'Day: %s', 'events' ), mysql2date( bpe_get_option( 'date_format' ), bp_action_variable( 1 ), true ) ) ?></h4>

    <?php do_action( 'bpe_group_day_before_loop' ) ?>
    ...
    <?php do_action( 'bpe_group_day_inside_loop' ) ?>
	
	</ul>

    <?php do_action( 'bpe_group_day_after_loop' ) ?>
