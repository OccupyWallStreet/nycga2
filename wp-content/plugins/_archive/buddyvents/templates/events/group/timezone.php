...
if( bpe_has_events() ) : ?>
	...
	<h4><?php printf( __( 'Timezone: %s', 'events' ), bpe_get_config( 'timezones', bp_action_variable( 1 ) ) ) ?></h4>

    <?php do_action( 'bpe_group_timezone_before_loop' ) ?>
    ...
    <?php do_action( 'bpe_group_timezone_inside_loop' ) ?>
	
	</ul>
    
    <?php do_action( 'bpe_group_timezone_after_loop' ) ?>
