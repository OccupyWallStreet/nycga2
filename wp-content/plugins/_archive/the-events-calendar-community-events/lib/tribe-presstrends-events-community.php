...
function presstrends_plugin_tribe_events_community() {

// PressTrends Account API Key
$api_key = 'tije8ygaph33vjqfbnyv6irf0wzulmingvl2';
$auth = 'mv43ugkavq1zb6lundyunll4wrsj81045';

// Start of Metrics
global $wpdb;
$data = get_transient( 'presstrends_data_tribe-events-community' );
if (!$data || $data == ''){
...
set_transient('presstrends_data_tribe-events-community', $data, 60*60*24);}
}