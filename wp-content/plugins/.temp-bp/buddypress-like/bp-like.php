...
function bp_like_install() {
		...
		$default_text_strings = array(
			'like' => array(
				'default'	=> __('Twinkle', 'buddypress-like'), 
				'custom'	=> __('Twinkle', 'buddypress-like')
			),
			'unlike' => array(
				'default'	=> __('Remove Twinkle', 'buddypress-like'),
				'custom'	=> __('Remove Twinkle', 'buddypress-like')
			),
			'like_this_item' => array(
				'default'	=> __('Twinkle this item', 'buddypress-like'),
				'custom'	=> __('Twinkle this item', 'buddypress-like')
			),
			'unlike_this_item' => array(
				'default'	=> __('Remove Twinkle this item', 'buddypress-like'),
				'custom'	=> __('Remove Twinkle this item', 'buddypress-like')
			),
			'view_likes' => array(
				'default'	=> __('View twinkles', 'buddypress-like'),
				'custom'	=> __('View twinkles', 'buddypress-like')
			),
			'hide_likes' => array(
				'default'	=> __('Hide twinkles', 'buddypress-like'),
				'custom'	=> __('Hide twinkles', 'buddypress-like')
			),
			'show_activity_likes' => array(
				'default'	=> __('Show Activity Twinkles', 'buddypress-like'),
				'custom'	=> __('Show Activity Twinkles', 'buddypress-like')
			),
			'show_blogpost_likes' => array(
				'default'	=> __('Show Blog Post Twinkles', 'buddypress-like'),
				'custom'	=> __('Show Blog Post Twinkles', 'buddypress-like')
			),
			'must_be_logged_in' => array(
				'default'	=> __('Sorry, you must be logged in to twinkle that.', 'buddypress-like'),
				'custom'	=> __('Sorry, you must be logged in to twinkle that.', 'buddypress-like')),
			'record_activity_likes_own' => array(
				'default'	=> __('%user% twinkled their own <a href="%permalink%">activity</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled their own <a href="%permalink%">activity</a>', 'buddypress-like')
			),
			'record_activity_likes_an' => array(
				'default'	=> __('%user% twinkled an <a href="%permalink%">activity</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled an <a href="%permalink%">activity</a>', 'buddypress-like')
			),
			'record_activity_likes_users' => array(
				'default'	=> __('%user% twinkled %author%\'s <a href="%permalink%">activity</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled %author%\'s <a href="%permalink%">activity</a>', 'buddypress-like')
			),
			'record_activity_likes_own_blogpost' => array(
				'default'	=> __('%user% twinkled their own blog post, <a href="%permalink%">%title%</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled their own blog post, <a href="%permalink%">%title%</a>', 'buddypress-like')
			),
			'record_activity_likes_a_blogpost' => array(
				'default'	=> __('%user% twinkled a blog post, <a href="%permalink%">%title%</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled an blog post, <a href="%permalink%">%title%</a>', 'buddypress-like')
			),
			'record_activity_likes_users_blogpost' => array(
				'default'	=> __('%user% twinkled %author%\'s blog post, <a href="%permalink%">%title%</a>', 'buddypress-like'),
				'custom'	=> __('%user% twinkled %author%\'s blog post, <a href="%permalink%">%title%</a>', 'buddypress-like')
			),
			'get_likes_no_likes' => array(
				'default'	=> __('Nobody twinkled this yet.', 'buddypress-like'),
				'custom'	=> __('Nobody twinkled this yet.', 'buddypress-like')
			),
			'get_likes_only_liker' => array(
				'default'	=> __('You are the only person who has twinkled this so far.', 'buddypress-like'),
				'custom'	=> __('You are the only person who has twinkled this so far.', 'buddypress-like')
			),
			'get_likes_you_and_singular' => array(
				'default'	=> __('You and %count% other person have twinkled this.', 'buddypress-like'),
				'custom'	=> __('You and %count% other person have twinkled this.', 'buddypress-like')
			),
			'get_likes_you_and_plural' => array(
				'default'	=> __('You and %count% other people have twinkled this', 'buddypress-like'),
				'custom'	=> __('You and %count% other people have twinkled this', 'buddypress-like')
			),
			'get_likes_count_people_singular' => array(
				'default'	=> __('%count% person twinkled this.', 'buddypress-like'),
				'custom'	=> __('%count% person twinkled this.', 'buddypress-like')
			),
			'get_likes_count_people_plural' => array(
				'default'	=> __('%count% people have twinkled this.', 'buddypress-like'),
				'custom'	=> __('%count% people have twinkled this.', 'buddypress-like')
			),
			'get_likes_and_people_singular' => array(
				'default'	=> __('and %count% other person twinkled this.', 'buddypress-like'),
				'custom'	=> __('and %count% other person twinkled this.', 'buddypress-like')
			),
			'get_likes_and_people_plural' => array(
				'default'	=> __('and %count% other people twinkled this.', 'buddypress-like'),
				'custom'	=> __('and %count% other people twinkled this.', 'buddypress-like')
			),
			'get_likes_likes_this' => array(
				'default'	=> __('twinkled this.', 'buddypress-like'),
				'custom'	=> __('twinkled this.', 'buddypress-like')
			),
			'get_likes_like_this' => array(
				'default'	=> __('twinkle this.', 'buddypress-like'),
				'custom'	=> __('twinkle this.', 'buddypress-like')
			),
			'get_likes_no_friends_you_and_singular' => array(
				'default'	=> __('None of your friends have twinkled this yet, but you and %count% other person have.', 'buddypress-like'),
				'custom'	=> __('None of your friends have twinkled this yet, but you and %count% other person have.', 'buddypress-like')
			),
			'get_likes_no_friends_you_and_plural' => array(
				'default'	=> __('None of your friends have twinkled this yet, but you and %count% other people have.', 'buddypress-like'),
				'custom'	=> __('None of your friends have twinkled this yet, but you and %count% other people have.', 'buddypress-like')
			),
			'get_likes_no_friends_singular' => array(
				'default'	=> __('None of your friends have twinkled this yet, but %count% other person has.', 'buddypress-like'),
				'custom'	=> __('None of your friends have twinkled this yet, but %count% other person has.', 'buddypress-like')
			),
			'get_likes_no_friends_plural' => array(
				'default'	=> __('None of your friends have twinkled this yet, but %count% other people did.', 'buddypress-like'),
				'custom'	=> __('None of your friends have twinkled this yet, but %count% other people did.', 'buddypress-like')
			)
		);
