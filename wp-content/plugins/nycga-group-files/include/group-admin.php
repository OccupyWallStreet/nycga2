...
add_action( 'admin_menu', 'nycga_group_files_group_admin_nav', 2 );
 ...
 */
function nycga_group_files_group_admin_menu() {
...
//add_action('plugins_loaded','nycga_group_files_group_admin_menu');
...
function nycga_group_files_group_admin_edit() {
	...
	if( !get_option( 'nycga_group_files_enable_all_groups' ) ) {
		...
		<p><label><?php _e('Enable documents for this group:','nycga-group-files'); ?></label>
