	...
	<form id="event-form" method="post" action="">
		<div class="wrap">			
			...
			<div class="inside event-form-name">
				...
				<div>
					<h4 class="event-form-name"><?php _e ( 'Group', 'dbem' ); ?></h4>
					<?php if( count($user_groups) > 0 ): ?>
						<select name="group_id" class="chzn">
			...
			<div class="inside event-form-where">
				<div id="em-location-data" style="padding-right:20px; vertical-align:top;">
					...
					<select name="location_id" id='location-select-id' class="chzn" size="1">  
						<?php 
			...
			<h4 class="event-form-details"><?php _e ( 'Event Details', 'dbem' ); ?></h4>
			<div class="inside event-form-details">
				...
				<?php if(get_option('dbem_categories_enabled')) :?>
					...
					<?php if( count($categories) > 0 ): ?>
						...
						<select name="event_categories[]" class="chzn" multiple size="10">
							<?php
