...
<div class="wrap">
	...
	<div class="inside">
		...
		<table class="form-table">
			...
			<tr>
				<th>
					<label for="visitor_method"><?php _e( 'After Visitor Submits a Question', QA_TEXTDOMAIN ) ?></label>
				</th>
					<td>
					...
					<br />
					<span class="description">
					<?php _e( 'Every question should have an author. If you want to let the visitor submit a question without the need for registration, you can assign a preset question author. Assigning a random author is possible using <code>qa_before_insert_post</code> filter, with which you can override the preset author.', QA_TEXTDOMAIN ) ?>
					</span>
					</td>
			</tr>
