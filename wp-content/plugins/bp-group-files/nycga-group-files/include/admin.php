...
?>
	<div class="wrap">
		...
		<form action="<?php echo network_admin_url() . 'admin.php?page=nycga-group-files-settings' ?>" name="group-files-settings-form" id="group-files-settings-form" method="post">				
