...
var fieldSettings = {
    ...
    "product"   :     ".visibility_setting, .product_field_type_setting, .conditional_logic_field_setting, .prepopulate_field_setting, .label_setting, .admin_label_setting, .description_setting, .css_class_setting",
    "singleproduct" : ".visibility_setting, .base_price_setting, .disable_quantity_setting, .rules_setting, .duplicate_setting",
    "price" :         ".visibility_setting, .rules_setting, .duplicate_setting",
    ...
    "shipping"   :    ".visibility_setting, .shipping_field_type_setting, .conditional_logic_field_setting, .prepopulate_field_setting, .label_setting, .admin_label_setting, .description_setting, .css_class_setting",
    "singleshipping": ".visibility_setting, .base_price_setting",
    "option"    :     ".visibility_setting, .product_field_setting, .option_field_type_setting, .conditional_logic_field_setting, .prepopulate_field_setting, .label_setting, .admin_label_setting, .default_value_setting, .description_setting, .css_class_setting",
    "quantity"  :     ".visibility_setting, .product_field_setting, .quantity_field_type_setting, .conditional_logic_field_setting, .prepopulate_field_setting, .label_setting, .admin_label_setting, .default_value_setting, .description_setting, .css_class_setting",
    "donation"  :     ".visibility_setting, .conditional_logic_field_setting, .donation_field_type_setting, .prepopulate_field_setting, .error_message_setting, .label_setting, .admin_label_setting, .rules_setting, .default_value_setting, .description_setting, .css_class_setting",
