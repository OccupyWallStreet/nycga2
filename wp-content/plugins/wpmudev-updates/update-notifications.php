                        ...
                        foreach ( $themes_files as $themes_file ) {
                                ...
                                if ( is_readable( "$themes_root/$themes_file" ) ) {
                                        ...
                                        if ( isset($data['id']) && !empty($data['id']) ) {
                                                $projects[$themes_file]['id'] = $data['id'];
                                                $projects[$themes_file]['type'] = 'theme';
                                                $projects[$themes_file]['version'] = $data['version'];
                                                $projects[$themes_file]['filename'] = substr( $themes_file, 0, strpos( $themes_file, '/' ) );
                                        }
                                }
                        }
                }
