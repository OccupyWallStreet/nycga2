					...
					<?php while (have_posts()) : the_post(); ?>
						...
						<div class="post" id="post-<?php the_ID(); ?>">
							...
							<div class="post-content">
								...
								<p class="date"><?php the_time( __( 'F j, Y', 'groupblog' ) ) ?> <em><?php _e( 'in', 'buddypress' ) ?> <?php the_category(', ') ?> <?php printf( __( 'by %s', 'buddypress' ), bp_core_get_userlink( $post->post_author ) ) ?></em></p>
